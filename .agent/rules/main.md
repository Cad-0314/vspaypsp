...
{hdpay - hday api-hdpay.txt, yellow - caipay api-caipay.txt payable - silpay  api-silpay.txt, x2 - f2pay api-f2pay.txt, upi super -fendpay - fendpay.txt , ckpay - ckapay  api- ckpay.txt}
