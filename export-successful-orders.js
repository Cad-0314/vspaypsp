...
async function exportSuccessfulOrders() {
    try {
        ...
        console.log(`Found ${orders.length} successful orders with UTR & callback sent\n`);
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, 'Successful Orders');

        // Add summary sheet
        const summaryData = [
            { 'Metric': 'Total Successful Orders', 'Value': orders.length },
            { 'Metric': 'Date Range', 'Value': 'January 15-23, 2026' },
            { 'Metric': 'Channel', 'Value': 'UPI Super (Fendpay)' },
            { 'Metric': 'Filter', 'Value': 'Status=Success, UTR Present, Callback Sent' },
        ...
        // Save to Desktop
        const fileName = 'UPI_Super_Successful_Orders_Jan15-23_2026.xlsx';
        ...
        console.log(`Filter: Status=Success, UTR Present, Callback Sent=Yes`);
